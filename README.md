...
No additional source files are required for v1.0.2.
...
The parser in v1.0.2 is a **defensive heuristic parser**, not yet a guaranteed parser for every historical NSDL CAS layout. It extracts text from PDFs, identifies ISIN-linked lines, attempts to infer quantities and market values, and exposes confidence/warnings instead of silently fabricating data.
...
### v1.0.2 — Streamlit filename hotfix
...
### v1.0.2 — Password-protected CAS PDF support
